...
class Python_Coder_Tool(BaseTool):
    ...
    def execute(self, query):
        ...
        response = self.llm_engine(full_prompt, temperature=self.temperature, usage_by="[python coder] execute")
...
if __name__ == "__main__":
    ...
    tool = Python_Coder_Tool(model_string="vllm-Qwen3-30B-A3B-Instruct-2507")  ## vllm-{model_name}
    ...
    queries = [
        ...
        # "Calculate the total number of rectangles that can be formed in a regular dodecagon using its sides and diagonals, given that there are 6 directions of parallel lines and the known combinatorial result is 132."
    ]
